...
반응형: 기존 슬러 시스템의 브레이크포인트(sm 640 / md 768 / lg 1024 / xl 1280)를 그대로 물려받는다. `[ASSUMPTION]` 640px 이상에서의 구체적 배치(상품 그리드 열 수, 탭바→상단 내비 전환, 최대 폭)는 목업이 390px만 그렸으므로 확정된 바 없다. 구현 전 결정 필요.
